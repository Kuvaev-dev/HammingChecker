...
namespace HammingChecker
{
    class HammingEncoderWithSimulation : IHammingStrategy
    {
        ...
        public string Encode(string data)
        {
            ...
            // Симуляція помилки на вказаній позиції
        ...
        public string Decode(string encodedData)
        {
            ...
            {
                throw new ArgumentException("Вхідні закодовані дані повинні містити 7 бітів.");
            }

            // Ініціалізація коду Хемінга з 7 бітів
            ...
            // Виправлення симульованої помилки
            if (errorPosition >= 0 && errorPosition < 7)
            {
                hammingCode[errorPosition] = (hammingCode[errorPosition] == '0') ? '1' : '0';
            }

            if (calculatedErrorPosition >= 0 && calculatedErrorPosition < 7)
            {
                // Перевертання біту на розрахованій позиції помилки для її виправлення
                hammingCode[calculatedErrorPosition] = (hammingCode[calculatedErrorPosition] == '0') ? '1' : '0';
            }
